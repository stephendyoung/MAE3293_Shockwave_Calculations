...
# upstream_static_user = Appendices(upstream_static_pressure=float(input("\nWhat is the upstream static pressure? ")))
...
if user_selection == "A":
    ...
    print(
        f'T0/T = {mach_number.T_0_over_T:.3f} P0/P = {mach_number.p_0_over_p:3f} Rho0/Rho = {mach_number.rho_0_over_rho:4f}')
elif user_selection == "B":
    mach_number.normal_shockwave()
    mach_number.isentropic()

    print(
        f'P_2/P_1 = {mach_number.p_2_static_over_p_1_static:.3f} Rho_2/Rho_1 {mach_number.rho_2_static_over_rho_1_static:.3f}'
    ...
    mach_number.normal_shock_calculations()
    print(f'\nDownstream Static Pressure (P2) = {mach_number.downstream_static_pressure:.3f}')
